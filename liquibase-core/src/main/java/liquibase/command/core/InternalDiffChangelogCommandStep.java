...
public class InternalDiffChangelogCommandStep extends InternalDiffCommandStep {
    ...
    static {
        ...
        // PATCH: Allow author to be defined
    ...
    protected DiffToChangeLog createDiffToChangeLogObject(DiffResult diffResult, CommandScope commandScope) {
        // PATCH: Set author and context from cli arg
        final DiffToChangeLog diffToChangeLog = new DiffToChangeLog(diffResult, commandScope.getArgumentValue(DIFF_OUTPUT_CONTROL_ARG));
        diffToChangeLog.setChangeSetAuthor(commandScope.getArgumentValue(AUTHOR_ARG));
        diffToChangeLog.setChangeSetContext(commandScope.getArgumentValue(CONTEXT_ARG));

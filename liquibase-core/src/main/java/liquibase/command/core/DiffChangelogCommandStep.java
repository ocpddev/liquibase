...
public class DiffChangelogCommandStep extends AbstractCliWrapperCommandStep {
    ...
    static {
        ...
        // PATCH: Allow changeSetAuthor to be recognized
        AUTHOR_ARG = builder.argument("changeSetAuthor", String.class).build();
        CONTEXT_ARG = builder.argument("changeSetContext", String.class).build();
    }
